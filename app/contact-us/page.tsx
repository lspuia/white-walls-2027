...
export const metadata: Metadata = {
  title: "Contact Us | White Walls Interior Design",
  description: "Get in touch with White Walls Interior Design in Aizawl, Mizoram. Call us or visit our office.",
};

function FacebookIcon() {
  return (
    <svg width="40" height="40" viewBox="0 0 101 101" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Facebook">
      <path d="M100.013 50.3125C100.013 22.525 77.625 0 50.0125 0C22.3875 0.00625 0 22.525 0 50.3188C0 75.425 18.2875 96.2375 42.1875 100.012V64.8563H29.5V50.3188H42.2V39.225C42.2 26.6188 49.6688 19.6562 61.0875 19.6562C66.5625 19.6562 72.2812 20.6375 72.2812 20.6375V33.0125H65.975C59.7687 33.0125 57.8313 36.8937 57.8313 40.875V50.3125H71.6937L69.4812 64.85H57.825V100.006C81.725 96.2312 100.013 75.4188 100.013 50.3125Z" fill="#444" />
    </svg>
  );
}
...
function InstagramIcon() {
  return (
    <svg width="40" height="40" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Instagram">
      ...
      <main>
        ...
        <section style={{ paddingTop: "2rem", paddingBottom: "2rem" }}>
          <div className="container" style={{
            ...
            <div style={{ flexShrink: 0, minWidth: "13rem" }}>
              <div style={{ marginBottom: "2rem" }}>
                <h3>Phone</h3>
                <ul style={{ marginTop: "0.5rem" }}>
                  <li><a href="tel:9654956742" style={{ textDecoration: "none", color: "#0170b9" }}>9654 956 742</a></li>
                  <li style={{ marginTop: "0.5rem" }}><a href="tel:6909364955" style={{ textDecoration: "none", color: "#0170b9" }}>6909 364 955</a></li>
                </ul>
              </div>
              ...
              <div style={{ marginBottom: "2rem" }}>
                <h3>Email</h3>
                <a
                  href="mailto:kimi@whitewalls.in"
                  style={{ textDecoration: "none", color: "#0170b9", marginTop: "0.5rem", display: "block" }}
                >
                  kimi@whitewalls.in
                </a>
              </div>
              ...
              <div style={{ marginBottom: "2rem" }}>
                ...
                <address style={{ lineHeight: 1.4, marginTop: "0.5rem", marginBottom: "0.25rem" }}>
                  White Walls<br />
              ...
              <div>
                <h3>Follow Us</h3>
                <ul style={{ display: "flex", gap: "1rem", marginTop: "0.5rem" }}>
                  <li>
                    <a
            ...
            <div style={{ flexGrow: 1, minWidth: 280 }}>
              <iframe
                ...
                loading="lazy"
                title="White Walls location on Google Maps"
